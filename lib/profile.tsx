...
export type ProfileIconComponent = LucideIcon | ComponentType<{ size?: number }>;
...
export const profile = {
  email: "fuhoang84@googlemail.com",
  heroTechEyebrow: {
    primary: "Next.js",
    separatorA: " · Laravel · ",
    secondary: "MongoDB",
  ...
  heroCoreStack: "Next.js · React · Laravel · MongoDB",
  heroAdditionalStack: "Symfony · Python",
  heroEngineeringFocus: "Reliability · CI/CD · Performance",
  socialLinks: [
    {
