...
export const alt = "Fu Hoang portfolio preview";
export const size = {
  width: 1200,
  height: 630,
};
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 860 }}>
            ...
            >
              Next.js, React, Laravel, MongoDB. Production-grade delivery, testing,
              CI/CD, and platform improvement.
            </div>
          </div>
          ...
          >
            {["London", "Startups", "SaaS", "Enterprise"].map((item) => (
              <div
                key={item}
                style={{
